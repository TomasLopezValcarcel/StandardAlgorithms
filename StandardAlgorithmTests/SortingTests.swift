...
final class SortingTests: XCTestCase {
    ...
    func testMergeSortWithShuffledArraysOfIntegersReturnsThemInAscendingOrder() {
        //arrange
        let sorting = Sorting()
    ...
    func testInsertionkSortWithShuffledArraysOfIntegersReturnsThemInAscendingOrder() {
        //arrange
        let sorting = Sorting()
